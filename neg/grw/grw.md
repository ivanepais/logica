# Crecimiento / Expansión / Clientes
...
#### 3. Valor (Value Growth) — aumentar el valor percibido y capturado (precio, fidelización, marca).
...
#### 5. Crecimiento sostenible: Escalabilidad con rentabilidad positiva. Ideal: crecimiento de ingresos > crecimiento de costes
...
#### 5. Renovación o declive — innovar o reestructurar: → Métrica: nuevos ingresos (%).
...
#### 1. CAC (Coste de Adquisición de Cliente): Cuánto cuesta adquirir un cliente. Coste total marketing/ventas ÷ nuevos clientes.
...
##### El crecimiento real ocurre cuando los tres aumentan juntos.
...
Objetivo: que la empresa soporte mayor volumen sin romperse.
...
Monetización: ARPU, MRR/ARR, average order value.
...
##### La innovación es una actividad que puede (y debe) gestionarse: definir hipótesis, ejecutar experimentos y tomar decisiones basadas en datos.
...
##### Fracasar rápido y barato es valorado si produce aprendizaje.
...
##### Define métricas accionables y criterios de éxito/fallo.
...
#### 1. Innovadores (tech enthusiasts) — buscan novedad, toleran imperfecciones.
...
#### 5. Lanza un caso de referencia con un cliente piloto del nicho y documenta resultados (ROI, mejoras operativas).
...
% de requisitos del Whole Product cubiertos.
...
### 3. Ventaja de escala (tamaño importa para costos, datos o partnerships). 
...
##### Blitzscaling describe etapas con diferentes retos y estructuras organizativas:
...
#### Quema de caja insostenible (burn rate excesivo).
...
#### 3. Necesidad de maximizar rentabilidad y procesos.
...
#### Sistemas para atraer, seleccionar, evaluar y desarrollar talento (ej.: “Topgrading”, A-players, roles claros).
...
#### 2. Reuniones diarias cortas para coordinación.
...
Daily huddle (5–15 min): sincronización rápida de equipo; 3 preguntas: ¿qué hice ayer? ¿qué haré hoy? ¿bloqueos?
...
#### Mejorar cobranzas (descuentos por pronto pago, facturación electrónica).
...
Revisar cash flow weekly; aplicar 1 táctica para mejorar cash.
...
##### Ej: “¿Cuál es nuestro churn mensual?” a “¿Los clientes que se unieron en enero se retienen mejor que los de febrero?”
...
No incluye factores externos (mercado, estacionalidad, etc.).
...
##### LTV = el valor total que el cliente genera a lo largo de su relación con tu negocio.
...
→ Cada cliente vale $320 en el tiempo.
...
#### Payback Period= CAC/ingreso neto mensual por cliente
...
##### Para inversionistas, son la base del product-market fit financiero.
...
##### 4. Implementar la prueba (A/B test, campaña, landing, etc.).
...
Ignorar el impacto en retención o revenue (solo mirar clics).
...
#### 3. En un intercambio voluntario y repetible.
...
#### 3. Sociales (estatus, pertenencia)
...
##### 3. Retención > adquisición. Mantener cuesta menos que conquistar.
...
Entregable: plan de adquisición por segmento (canal, mensaje, KPI).
...
Feedback & surveys: Typeform, Hotjar, Hotjar/FullStory para recordings.
...
Empieza por hablar con clientes reales: 10–15 entrevistas aportan muchísimo.
...
##### Si no mencionan un problema concreto.
...
#### 1. El cliente quiere pagarte o saber cuándo puede usarlo.
...
#### pero casi nada en mantenerlos felices después de la venta.”
...
#### Cómo: Mostrar progreso medible (“Has ahorrado 10 horas este mes”); Testimonios o historias de éxito; Pequeños reconocimientos o recompensas.
...
#### 5. La retención es más rentable que la adquisición: Mantener clientes cuesta 5–25 veces menos que conseguir nuevos.
...
#### Objetivo: identificar qué métricas importan y dónde hay mayor impacto potencial.
...
### 1. Analizar: Datos y comportamiento de usuario. Identificar oportunidades
...
## 2. Action (Acción): Es el comportamiento más simple que el usuario realiza en respuesta al trigger para obtener una recompensa. 
...
#### Ej: Subir una foto a Instagram. Crear una playlist en Spotify. Personalizar un perfil. Dejar reseñas, favoritos o configuraciones.
...
##### Que ayuden al usuario a lograr sus metas.
...
#### Spotify: Necesidad emocional / música. Nuevas playlists. Crear listas
...
### 3. Acción organizacional: Los equipos usan el feedback para cerrar el ciclo con el cliente. Ejemplo: contactar a detractores para entender su problema y resolverlo.O reforzar prácticas que generan promotores.
...
##### Economía conductual: las recomendaciones entre pares influyen más que la publicidad.
...
Promotores (9–10): clientes leales que recomiendan y repiten.
...
## Earned Growth: El verdadero crecimiento proviene de clientes ganados por recomendación, no por marketing pago.
...
| **Responsable** | Marketing / CX   | Toda la organización           |
| **Impacto**     | Cuantitativo     | Estratégico y cultural         |


## Fundamentos psicológicos y económicos

#### Psicología social: la recomendación es una señal de confianza y prestigio.

#### Economía conductual: las emociones positivas y la reciprocidad impulsan la lealtad.

#### Estrategia de crecimiento: los clientes promotores generan “crecimiento compuesto” — cada cliente atrae más clientes.


## Principios finales de Reichheld y Markey

La lealtad auténtica genera beneficios duraderos.

El feedback de los clientes es un regalo, no una estadística.

#### Los líderes deben servir a los empleados para que estos sirvan al cliente.

El propósito superior debe guiar la rentabilidad.

El NPS no es el fin, sino el medio para construir relaciones humanas reales.


## Rs

#### La Pregunta Clave: “¿Recomendarías nuestra empresa?”

#### La Métrica: % Promotores − % Detractores

#### El Sistema: Feedback + Acción + Cultura

#### El Resultado: Crecimiento orgánico y sostenible

#### El Propósito: Enriquecer la vida de clientes y empleados

##### “El Net Promoter System no se trata de medir satisfacción, sino de construir relaciones que hagan la vida de las personas mejor — y que ese bien se refleje en el crecimiento de la empresa.”



# Customer success - Nick Mehta

Obra fundacional del movimiento “Customer Success” moderno.

#### Redefine cómo las empresas —especialmente las de modelo SaaS y suscripciones— deben gestionar la relación con el cliente para garantizar su éxito continuo, no solo la venta inicial.


## Idea: “El éxito del cliente es el éxito de la empresa.”

Observación clave:

Antes, las empresas se centraban en cerrar ventas.

##### Hoy, en negocios basados en ingresos recurrentes (SaaS, suscripciones), el valor se crea solo si el cliente sigue usando y obteniendo resultados.

##### Surge una nueva disciplina:

#### Customer Success (CS) = ayudar proactivamente a los clientes a alcanzar los resultados deseados con tu producto, asegurando su retención y expansión.
...
En los modelos tradicionales (venta única), el ingreso se concretaba al vender.

En SaaS/subscripción, los ingresos llegan en el tiempo.

Si el cliente cancela (churn), se destruye el valor.


Entonces:

#### El foco cambia de “vender bien” a “asegurar adopción, resultados y renovación”.


## Tres fuerzas que crearon el movimiento “Customer Success”

### 1. La economía de la suscripción: El crecimiento depende de mantener clientes más que de adquirir nuevos.

### 2. La explosión del software en la nube (SaaS): La facilidad de cambiar proveedor aumenta el riesgo de churn.

### 3. El acceso a datos de uso del cliente: Ahora las empresas pueden medir el comportamiento real del usuario y anticipar riesgos o oportunidades.
...
### 1. Retención (Reducir el Churn): “El churn es el enemigo natural del crecimiento.”

##### El churn ocurre cuando un cliente cancela, deja de renovar o no usa el producto.

#### La primera misión del Customer Success es identificar, prevenir y reducir el churn a través de:

##### 1. Monitoreo del uso del producto (engagement, adopción).

##### 2. Comunicación proactiva antes de los momentos de riesgo.

##### 3. Acompañamiento durante la curva de aprendizaje.

##### 4. Resolución rápida de fricciones.

##### Métrica clave: Net Revenue Retention (NRR) o Customer Retention Rate (CRR)


### 2. Expansión (Crecimiento dentro de la base de clientes)

#### Una vez asegurada la retención, el siguiente paso es expandir valor con los clientes existentes:

##### 1. Upsell: vender versiones premium o más asientos/licencias.

##### 2. Cross-sell: ofrecer productos complementarios.

##### 3. Advocacy: convertir clientes satisfechos en promotores y referencias

##### Empresas líderes logran “crecimiento neto positivo”, donde las expansiones superan al churn.

##### Métrica clave: Net Dollar Retention (NDR) = (Ingresos iniciales + expansión – churn) / ingresos iniciales


### 3. Alineación (Éxito conjunto)

#### El enfoque de Customer Success no es “servicio postventa” ni “soporte técnico”: es una filosofía transversal que involucra:

##### Producto, Ventas, Marketing, Finanzas, Soporte

#### Todo el equipo debe alinear sus incentivos hacia el éxito real del cliente, no solo sus cuotas individuales.

##### "El éxito del cliente no es un departamento: es una mentalidad de toda la empresa."


## Cambio de paradigma

| Enfoque tradicional     | Enfoque Customer Success        |
| ----------------------- | ------------------------------- |
| “Cerrar ventas.”        | “Garantizar resultados.”        |
| Éxito = venta           | Éxito = renovación y expansión  |
| Reacción ante problemas | Prevención proactiva            |
| Soporte técnico aislado | Relación continua y estratégica |
| Ingreso inmediato       | Ingreso compuesto a largo plazo |


## Modelo de madurez del Customer Success

Etapa | Características

#### 1. Caótica: No hay proceso formal; reacciones ante quejas.

#### 2. Reactiva: Se responde a tickets y churns; poco análisis.

#### 3. Proactiva: Se monitorean datos y se contacta al cliente antes del problema.

#### 4. Predictiva: Se usan métricas de salud y modelos de riesgo.

#### 5. Transformacional: Toda la empresa opera con mentalidad CS.


## Customer Health Score: Herramienta clave: un indicador compuesto que mide la “salud” del cliente.

#### Incluye variables como: Frecuencia de uso, Profundidad de adopción (cuántas funciones usa), NPS o satisfacción, Actividad del equipo, Renovaciones anteriores, Tickets abiertos / resueltos

##### Objetivo: predecir riesgo de churn y activar alertas tempranas.


## Estructura del equipo de Customer Success

##### Distingue 3 roles principales dentro del área:

### 1. Customer Success Manager (CSM): Relación postventa, adopción, renovación. Retención, NRR, satisfacción.

### 2. Onboarding Specialist: Primeras semanas, implementación. Tiempo de valor, activación.

### 3. Renewals / Expansion Manager: Renovaciones y ventas adicionales. NDR, upsell rate.
...
| --------------------------------- | ---------------------------------------- | --------------------------- |
| **Churn Rate**                    | % de clientes o ingresos que se pierden. | < 5% anual en SaaS maduros. |
| **Retention Rate**                | % de clientes retenidos.                 | > 90% deseable.             |
| **Net Revenue Retention (NRR)**   | Incluye expansión y churn.               | > 100% ideal.               |
| **Customer Health Score**         | Índice de riesgo/éxito.                  | Anticipar churn.            |
| **Customer Lifetime Value (CLV)** | Valor total proyectado del cliente.      | Maximizarlo.                |


## Estrategias

#### 1. Onboarding efectivo: el cliente debe alcanzar valor en los primeros 30-60 días.

#### 2. Momentos de valor: identificar hitos donde el cliente siente progreso (aha moments).

#### 3. Mapas de viaje del cliente (Customer Journey Maps): detectar puntos de fricción.

#### 4. Segmentación: adaptar el acompañamiento según tipo y tamaño de cliente.

#### 5. Automatización y escalabilidad: usar datos y flujos automatizados para clientes de baja complejidad.

#### 6. Cultura de “land and expand”: entrar con valor mínimo y crecer dentro del cliente.

#### 7. Adopción continua: no basta con que compren, deben usar y obtener ROI tangible.


## ROI del Customer Success

Demuestra con datos que:

#### Un aumento del 5% en retención puede aumentar beneficios entre 25% y 95%.

#### Empresas con alto NRR crecen 2–3 veces más rápido.

#### CS reduce CAC (Customer Acquisition Cost) al generar crecimiento orgánico y referidos.


## Marco conceptual: Customer Success Equation

#### Customer Success = Adoption × Value × Experience

##### 1. Adoption: el cliente usa efectivamente el producto.

##### 2. Value: obtiene resultados medibles.

##### 3. Experience: se siente acompañado y comprendido.

##### Si falta cualquiera de los tres, el éxito (y la renovación) está en riesgo.


## Cultura del Customer Success: no es un software ni un proceso, sino una filosofía.

#### 1. Empatía radical: Comprender los objetivos reales del cliente.

#### 2. Responsabilidad compartida: El éxito del cliente pertenece a toda la empresa.

#### 3. Proactividad y prevención: No esperar a que el cliente se queje.

#### 4. Aprendizaje continuo: Cada interacción genera insight para producto, ventas y soporte.

#### 5. Métricas compartidas: Toda la organización mide impacto en NRR, churn y satisfacción.


## Clientes y su éxito

#### “No existe el éxito del cliente sin éxito del negocio, ni éxito del negocio sin éxito del cliente.”

#### “Customer Success es la ciencia de mantener y hacer crecer los ingresos, ayudando a los clientes a alcanzar sus resultados deseados.”

#### “Cada contacto con el cliente es una oportunidad de expansión o de abandono.”
...
| -------------- | -------------------------- | ---------------------------- |
| **Retención**  | Reducir churn              | Retention Rate, Health Score |
| **Expansión**  | Crecer ingresos existentes | NRR, Upsell Rate             |
| **Alineación** | Integrar toda la empresa   | NPS, CLV, Engagement         |


## Conclusión

#### El Customer Success transforma la relación empresa-cliente: de transaccional a continua.

Las empresas que dominan CS (Salesforce, Gainsight, HubSpot, Slack, Zoom) logran crecimiento compuesto, rentabilidad alta y clientes evangelizadores.

#### En un mundo de suscripciones, Customer Success no es opcional: es la estrategia central de supervivencia y crecimiento



# Retention

##### Uno de los pilares más importantes del crecimiento sostenible de cualquier negocio: la retención (Retention).

##### Se relaciona directamente con la lealtad del cliente, el valor de vida (LTV) y la rentabilidad compuesta.


## Retención

#### Capacidad de una empresa para mantener a sus clientes a lo largo del tiempo.

##### Se mide como el porcentaje de usuarios que continúan comprando, usando o pagando un producto o servicio después de un período determinado

##### Retener es lograr que el cliente vuelva y permanezca.


#### Es el motor oculto del crecimiento empresarial.

#### Mientras la adquisición trae nuevos clientes, la retención sostiene y multiplica su valor.

##### Estudios clásicos (Bain & Co, Reicheld) muestran que:

##### Aumentar la retención un 5% puede elevar las ganancias entre 25% y 95%.

#### El costo de adquirir un nuevo cliente (CAC) puede ser 5 a 7 veces mayor que el de retener uno existente.

Clientes retenidos compran más, pagan más y recomiendan más.

#### Crecimiento sostenible = Adquisición + Retención – Churn


## Métricas fundamentales de Retention

| Métrica                           | Descripción                                                          | Fórmula                                                      |
| --------------------------------- | -------------------------------------------------------------------- | ------------------------------------------------------------ |
| **Customer Retention Rate (CRR)** | Porcentaje de clientes que permanecen activos después de un periodo. | `[(Clientes fin – Nuevos clientes) / Clientes inicio] × 100` |
| **Churn Rate**                    | Porcentaje de clientes que se van o cancelan.                        | `(Clientes perdidos / Clientes inicio) × 100`                |
| **Revenue Retention (Gross/Net)** | Porcentaje de ingresos retenidos considerando o no expansiones.      | `Ingresos retenidos / Ingresos iniciales`                    |
| **Customer Lifetime Value (CLV)** | Valor total esperado del cliente durante su relación.                | `Ingreso promedio × Duración × Margen`                       |
| **Repeat Purchase Rate**          | % de clientes que vuelven a comprar.                                 | `(Clientes con +1 compra / Clientes totales)`                |


## Tipos de Retención

#### Existen tres niveles de retención, que deben gestionarse de forma complementaria:

### 1. Retención de usuarios (usage retention): Que el usuario siga usando el producto. Indicador: DAU/MAU, sesiones, engagement

### 2. Retención de clientes (customer retention): Que el cliente no se dé de baja o cancele. CRR, churn

### 3. Retención de ingresos (revenue retention): Que el ingreso del cliente no caiga y se expanda. NRR, ARPU


#### En SaaS, la más importante es Revenue Retention (NRR):

##### Si tus ingresos netos crecen incluso con churn, estás en una fase de crecimiento compuesto.


## Fundamentos psicológicos

La retención se basa en comportamientos humanos.

#### Los clientes permanecen cuando sienten valor, conexión y confianza.

### 1. Valor percibido: El cliente siente que el producto sigue resolviendo su necesidad mejor que las alternativas.

### 2. Coste de cambio: Cambiar de proveedor requiere esfuerzo, datos, tiempo, aprendizaje.

### 3. Hábito y ritual: El uso continuo se vuelve automático y natural.

### 4. Confianza y relación: Experiencias positivas generan apego y lealtad.

### 5. Identidad y pertenencia: El cliente se identifica con la marca o comunidad.

#### Por eso, retener no es solo “evitar churn”: es crear una relación emocional y funcional duradera.


## Etapas de la Retención

#### La retención no ocurre de golpe; es el resultado de una secuencia de momentos críticos dentro del ciclo de vida del cliente.

##### Etapa | Objetivo | Indicadores

### 1. Onboarding: Lograr que el cliente alcance el primer “momento de valor”. Activación, tiempo a valor

### 2. Adopción: Que use el producto de forma consistente. Frecuencia, profundidad de uso

### 3. Que sienta satisfacción y utilidad continua: NPS, reseñas, interacción

### 4. Renovación / Recompra: Que vuelva a comprar o renovar. CRR, churn

### 5. Expansión / Advocacy: Que crezca su valor y recomiende. NRR, referidos, upsell


## Factores clave que impulsan la Retención

### 1. Valor continuo: el cliente debe seguir obteniendo resultados concretos.

### 2. Experiencia sin fricción: facilidad de uso, soporte rápido, procesos fluidos.

### 3. Comunicación proactiva: anticiparse a problemas o abandonos.

### 4. Personalización: adaptar interacciones y recomendaciones.

### 5. Confianza: cumplir promesas y cuidar la relación.

### 6. Comunidad: generar sentido de pertenencia o aprendizaje entre clientes.

### 7. Innovación constante: evitar que el producto quede obsoleto.


## Estrategias de Retención

### 1. Onboarding guiado: Ayudar al cliente a obtener su primer éxito rápido. Tutoriales, “welcome email”, CSM dedicado.

### 2. Customer Success proactivo: Supervisar uso y contacto antes de problemas. Health score, alertas de churn.

### 3. Programas de lealtad: Recompensar la permanencia o frecuencia. Puntos, descuentos, membresías.

### 4. Contenido educativo: Formar al cliente para obtener más valor. Webinars, academias, documentación.

### 5. Feedback loops: Escuchar e incorporar sugerencias. Encuestas NPS, foros, beta testers.

### 6. Comunidad y red: Fomentar interacción entre clientes. Slack, foros, grupos.

### 7. Upselling positivo: Ofrecer mejoras cuando el cliente está preparado. Planes premium, módulos extra.


## Retention vs Churn

#### Retention y Churn son dos caras de la misma moneda:

##### Retention mide quién se queda.

##### Churn mide quién se va.

##### Reducir churn no siempre equivale a aumentar retención si los clientes retenidos no crecen ni están satisfechos.

#### Lo ideal: apuntar a “Net Negative Churn” → las expansiones compensan y superan las pérdidas.


## Ecuación del valor del cliente (LTV y Retención)

El Customer Lifetime Value (LTV) depende directamente de la retención:

#### LTV= (Ingreso Promedio por Cliente × Margen Bruto) / Tasa de Churn

#### Una leve mejora en Retención aumenta exponencialmente el LTV, y por ende, el presupuesto disponible para adquirir nuevos clientes.


## Retención como sistema

#### Podemos ver la Retención como un sistema cíclico y transversal, compuesto por:

### 1. Datos → medir comportamiento, uso y satisfacción.

### 2. Insight → detectar señales de riesgo o valor.

### 3. Acción → intervenir con comunicación, educación o soporte

### 4. Evaluación → medir impacto y ajustar el proceso.

Este ciclo nunca se detiene — es el “corazón operativo” de empresas como HubSpot, Slack o Notion.


## Cultura de Retención

##### Los negocios con alta retención comparten una filosofía común:

#### “No queremos solo cerrar ventas; queremos crear historias de éxito.”

#### “Cada cliente que se va nos enseña más que diez que llegan.”

#### “La mejor estrategia de adquisición es un cliente feliz.”

##### En este sentido, retención = confianza compuesta: los resultados crecen con el tiempo, igual que los intereses de una inversión.


## Ej: dos empresas SaaS

| Empresa | Retención Anual | Crecimiento Clientes | Resultado |
| ------- | --------------- | -------------------- | --------- |
| A       | 80%             | +30% nuevos          | +10% neto |
| B       | 95%             | +30% nuevos          | +25% neto |

#### En 3 años, la empresa B duplica los ingresos de A, solo por tener mejor retención.


## Rs

#### Mantener clientes activos y comprometidos. Objetivo: Sostenibilidad

#### Importancia: Reduce costos, aumenta beneficios, impulsa crecimiento: Rentabilidad

#### Cómo lograrlo: Valor, confianza, hábito, comunicación proactiva. Lealtad

#### Métricas clave: CRR, churn, NRR, LTV, Health Score. Control

#### Cultura: “El éxito del cliente es nuestro éxito.”. Fidelización real 



# Winback / Customer Re-activation / Re-engagement

##### Una de las áreas más estratégicas —y a menudo subestimadas— dentro de la gestión de clientes y el crecimiento sostenible.  

##### Mientras la retención (Retention) busca mantener a los clientes activos

#### El winback busca recuperar a los clientes perdidos o inactivos.  


## Winback: ganar de nuevo

##### Conjunto de estrategias diseñadas para reconectar, recuperar y reactivar a clientes que han dejado de comprar o usar un producto o servicio.

#### Objetivo: restaurar la relación y el valor de clientes que ya habían mostrado interés o comprado antes.


## Importancia: Recuperar antiguos clientes suele ser más rentable que adquirir nuevos.

Estudios de marketing (Reichheld, Marketing Metrics) muestran que:

#### Las probabilidades de vender a un cliente inactivo son del 20–40%, mientras que a un prospecto nuevo apenas del 5–10%.

#### Un cliente reactivado ya conoce la marca, por lo tanto requiere menos educación y menos CAC.

#### El costo promedio de winback es 3 a 5 veces menor que el de adquisición.

##### En negocios de suscripción o e-commerce, los programas de winback bien ejecutados pueden recuperar hasta el 25–30% de clientes perdidos.


## Retención, Reactivación y Winback

| Concepto         | Enfoque                     | Cliente                | Objetivo                       |
| ---------------- | --------------------------- | ---------------------- | ------------------------------ |
| **Retención**    | Evitar que se vaya          | Activo                 | Permanencia                    |
| **Reactivación** | Recuperar uso o engagement  | Inactivo (aún cliente) | Volver a usar                  |
| **Winback**      | Recuperar relación o compra | Ex-cliente (ya se fue) | Volver a comprar / suscribirse |

#### Winback comienza una vez que la retención falló. 


## Fundamento estratégico del Winback

#### El principio central es el valor residual de la relación previa.

##### Un cliente perdido no es un cliente desconocido:

##### Ya sabe quién eres. Ya tuvo una experiencia (positiva o negativa). Ya tiene datos, preferencias, historial. Ya confió en ti una vez.

#### No partís de cero: Tu tarea no es convencerlo de que existís, sino reconstruir la confianza y reactivar el valor.


## Tipologías de clientes perdidos

#### Antes de hacer winback, se clasifican los ex-clientes según causa y valor potencial:

##### Tipo | Causa | Estrategia de Winback

### 1. Desconectado: Se olvidó o cambió de hábito. Recordatorios, incentivos, nuevas funciones.

### 2. Insatisfecho: Mala experiencia previa. Disculpa, empatía, solución personalizada.

### 3. Migrado: Se fue con competidor. Diferenciación clara, nueva propuesta.

### 4. Temporal: Pausó por motivos externos. Reenganche oportuno, comunicación empática.

### 5. No rentable: Alto costo o bajo margen. Evaluar si vale reactivar.

#### En estrategias maduras, no todos los clientes deben ser recuperados: solo aquellos con alto LTV potencial y bajo costo de retorno.


## Fundamentos psicológicos

El winback apela a procesos emocionales y cognitivos muy específicos:

##### Principio | Descripción | Aplicación

### 1. Reconocimiento: Las personas valoran ser recordadas. “Te extrañamos” o “Notamos que no has vuelto”.

### 2. Remordimiento: El cliente puede sentirse inseguro de su decisión. Mostrar mejoras o beneficios que se perdió.

### 3. Curiosidad: “¿Qué hay de nuevo?” es un disparador poderoso. Mostrar nuevas versiones, productos, funcionalidades.

### 4. Reciprocidad: Un incentivo puede generar retribución. Descuentos, meses gratis, regalos.

### 5. Pérdida (loss aversion): Las personas temen perder beneficios acumulados. “Tu plan especial expira pronto.”

### 6. Confianza restaurada: Una disculpa genuina puede reabrir relaciones. “Sabemos que fallamos, y lo corregimos.”


## Métricas

| Métrica                             | Qué mide                                   | Fórmula / Indicador                                |
| ----------------------------------- | ------------------------------------------ | -------------------------------------------------- |
| **Winback Rate**                    | % de clientes recuperados.                 | `(Clientes recuperados / Clientes perdidos) × 100` |
| **Reactivation Revenue**            | Ingreso generado por clientes reactivados. | Suma de ingresos de winbacks.                      |
| **Winback Cost per Customer (WCC)** | Costo medio de recuperar un cliente.       | `Gasto total en winback / Clientes recuperados`    |
| **Churn-to-Winback Ratio**          | Eficiencia global de la estrategia.        | `Winbacks / Churn total`                           |
| **Post-winback Retention Rate**     | Cuánto duran los recuperados.              | % que permanecen 3, 6, 12 meses.                   |


## Fases de un programa de Winback

### 1. Diagnóstico

Analizar causas del abandono (churn survey, entrevistas, datos de uso).

#### Segmentar ex-clientes por motivo, valor y probabilidad de retorno.

#### Identificar “ventanas de oportunidad” (momentos propicios para contactar).


### 2. Diseño del mensaje

##### Elegir tono y enfoque adecuado (emocional, racional o informativo).

##### Personalizar según causa de pérdida y valor del cliente.

#### Ofrecer una propuesta de retorno concreta y clara (incentivo, cambio, novedad).


### 3. Ejecución

#### Canales: email, SMS, redes, llamadas, publicidad segmentada.

##### Mensajes secuenciales (3–4 contactos progresivos).

#### Automatización + seguimiento manual para clientes valiosos.


### 4. Reonboarding

##### Asegurar que el cliente vuelva correctamente integrado.

#### Mostrar mejoras o nuevos beneficios de inmediato.

##### Acompañamiento y soporte durante las primeras semanas.


### 5. Medición y aprendizaje

Medir tasa de retorno y retención post-winback.

Analizar qué mensajes o segmentos respondieron mejor.

Ajustar frecuencia, tono y oferta para próximos ciclos
...
| -------------------------------------------- | ---------------------------------------- | ------------------------------------------------------ |
| **Campaña “Te extrañamos”**                  | Mensaje cálido, con incentivo o novedad. | “Vuelve y recibe 20% off.”                             |
| **Campaña “Lo nuevo que te perdiste”**       | Mostrar mejoras o innovaciones.          | “Desde que te fuiste, lanzamos esto.”                  |
| **Oferta personalizada**                     | Basada en hábitos previos.               | “Sabemos que te gustaba X, tenemos una nueva versión.” |
| **Encuesta de salida + invitación a volver** | Entender causas y ofrecer solución.      | “Queremos mejorar, contanos qué pasó.”                 |
| **Reactivación de contenido / comunidad**    | Retomar el vínculo emocional o social.   | Newsletter, grupo VIP, eventos.                        |
| **Llamadas 1:1 para cuentas valiosas**       | Atención humana personalizada.           | CSM o account manager recontacta directamente.         |


## Elementos clave del mensaje de Winback

##### Un buen mensaje de winback tiene 5 ingredientes:

### 1. Reconocimiento: “Sabemos que hace tiempo no nos visitas.”

### 2. Empatía: “Queremos entender cómo podemos hacerlo mejor.”

### 3. Valor: “Hay nuevas funciones / promociones / beneficios.”

### 4. Facilidad: “Un clic para volver.”

### 5. Urgencia: “Tu beneficio expira en 48h.”

#### Clave: no insistir, sino reinvitar. El tono debe ser humano, no comercial.


## ROI del Winback: El winback marketing tiene una alta rentabilidad cuando se aplica con precisión

El winback marketing tiene una alta rentabilidad cuando se aplica con precisión:

| Canal               | Winback Rate promedio   |
| ------------------- | ----------------------- |
| Email personalizado | 20–40%                  |
| SMS o WhatsApp      | 15–25%                  |
| Llamadas humanas    | 30–50% (en cuentas B2B) |
| Retargeting ads     | 5–15%                   |


## Integración con Retention y Customer Success

El winback no sustituye la retención ni el customer success; la complementa.

Retention: previene pérdidas futuras.

Customer Success: maximiza valor actual.

Winback: reactiva valor pasado.

Idealmente, el winback se gestiona desde el mismo sistema de datos (CRM, health score, historial de churn) y retroalimenta a los equipos de producto y marketing con insights sobre motivos reales de abandono.
...
| Error                                      | Consecuencia                         |
| ------------------------------------------ | ------------------------------------ |
| Enviar mensajes genéricos o masivos        | Rechazo o indiferencia.              |
| Contactar demasiado pronto                 | Puede parecer invasivo.              |
| No resolver la causa original del abandono | El cliente vuelve… y se vuelve a ir. |
| No medir resultados                        | Se desperdicia aprendizaje.          |
| No adaptar la oferta según segmento        | Bajo ROI.                            |


## Filosofía subyacente

##### “Cada cliente perdido es una historia inconclusa.”

##### “Winback no es insistir — es volver a ofrecer valor.”

##### “La relación con el cliente es como una cuenta bancaria de confianza: si se vacía, puede volver a llenarse si das el primer paso correcto.”
...
Una de las herramientas centrales en la comprensión, optimización y retención de clientes.


## Definición

#### Representación visual o conceptual del recorrido que hace un cliente (o usuario) desde que descubre una marca hasta que abandona o se convierte en promotor.

#### Su objetivo es entender la experiencia real del cliente, identificar puntos de fricción y oportunidades de mejora, y alinear a toda la organización con una visión centrada en el usuario.



## Fundamento

El CJM parte de una premisa clave:

#### “Las decisiones del cliente no se entienden analizando el embudo de ventas, sino el viaje completo que vive con la marca.”

##### Mientras el embudo (funnel) describe la conversión desde el punto de vista de la empresa

#### el mapa del viaje describe la experiencia desde el punto de vista del cliente.


## Estructura del mapa

##### Suele organizarse como una tabla o diagrama con etapas horizontales y dimensiones verticales:

| Etapas del viaje | Acciones del cliente | Pensamientos / emociones | Puntos de contacto | Oportunidades / problemas |
| ---------------- | -------------------- | ------------------------ | ------------------ | ------------------------- |

##### Cada fila o capa revela un nivel distinto de comprensión.


## Etapas típicas del viaje del cliente: Las etapas pueden variar según el negocio, pero suelen incluir:

### 1. Awareness (Conciencia): El cliente descubre la existencia de la marca o producto.

#### Objetivo: despertar interés y curiosidad.


### 2. Consideration (Evaluación): El cliente compara alternativas y busca información.

#### Objetivo: generar confianza y destacar beneficios 


### 3. Acquisition (Compra o adopción): Se realiza la transacción inicial.

#### Objetivo: ofrecer una experiencia de compra fluida y segura.


### 4. Onboarding (Inicio de uso): El cliente empieza a usar el producto o servicio.

#### Objetivo: reducir fricción, educar y asegurar valor rápido.


### 5. Retention (Uso continuado / lealtad): Retention (Uso continuado / lealtad)

#### Objetivo: aumentar frecuencia, satisfacción y valor percibido.


### 6. Advocacy (Promoción / recomendación): El cliente promueve la marca.

#### Objetivo: transformar la satisfacción en referencia activa (NPS alto).


## Capas o dimensiones del mapa: Un CJM completo analiza simultáneamente:

### 1. Acciones: qué hace el cliente (clics, compras, llamadas, búsqueda, etc.).

### 2. Pensamientos: qué se pregunta o espera (sus dudas y percepciones).

### 3. Emociones: cómo se siente en cada punto (frustrado, feliz, confundido…).

### 4. Touchpoints: dónde ocurre la interacción (web, app, sopo

### 5. Sistemas internos: qué áreas o procesos de la empresa participan.

### 6. Oportunidades: cómo mejorar la experiencia o eliminar fricciones.


## Tipos de Customer Journey Maps

### 1. Actual (As-Is): describe la experiencia real actual.

### 2. Futuro (To-Be): representa la experiencia ideal deseada.

### 3. Basado en datos: usa métricas reales, entrevistas, NPS, heatmaps, etc.

### 4. Basado en hipótesis: se construye al inicio del diseño o innovación.

### 5. Omnicanal: integra canales físicos, digitales y humanos.


## Herramientas y metodologías relacionadas

### Personas / arquetipos: definen los tipos de clientes que se mapean.

### Service Blueprint: complementa el CJM mostrando los procesos internos que sostienen cada interacción.

### Jobs To Be Done (JTBD): ayuda a entender el “trabajo” que el cliente quiere lograr en cada etapa.

### Experience Mapping: abarca experiencias más amplias (más allá del producto).


## Beneficios

##### Identificar puntos de fricción y momentos de verdad (momentos clave que definen la percepción del cliente).

##### Fomentar la empatía organizacional y la colaboración interdepartamental.

##### Priorizar iniciativas de mejora de CX (Customer Experience).

##### Medir impacto emocional y funcional en la retención.

##### Servir de base para estrategias de automatización, marketing relacional o customer success.


## Ejemplo: SaaS educativo

| Etapa | Acción | Emoción | Punto de contacto | Oportunidad

#### 1. Awareness: Ve un anuncio en redes. Curioso. Instagram: Crear contenido educativo más claro

#### 2. Consideration:  Lee reseñas. Esperanzado. Web / reviews. Mostrar casos de éxito

#### 3. Acquisition: Compra plan básico. Ansioso. Checkout web. Simplificar el pago

#### 4. Onboarding: Prueba las primeras lecciones. Motivado. Plataforma. Enviar guía rápida de uso

#### 5. Retention: Usa el curso cada semana. Satisfecho. Email / app. Gamificar progreso

#### 6. Advocacy: Recomienda a amigos. Orgulloso. Redes sociales. Programa de referidos


## Principio fundamental: “El valor del Customer Journey Map no está en el diagrama, sino en la conversación que genera dentro de la empresa.”

##### Es una herramienta de alineación y aprendizaje, no solo un entregable visual.

##### Debe actualizarse constantemente a medida que cambia el comportamiento del cliente o se lanzan nuevos productos.



# Adquisición/Customer Acquisition

#### Uno de los pilares del crecimiento empresarial —junto con la retención y la expansión— y combina marketing, producto, datos y estrategia.


## Definición

##### Conjunto de estrategias, procesos y sistemas destinados a atraer, convertir y captar nuevos clientes para una empresa o producto.

#### Su propósito es lograr un flujo constante de nuevos usuarios de forma rentable, predecible y escalable.

##### adquisición = “cómo las personas que no nos conocen se convierten en clientes.”


## Fundamento

##### La adquisición se basa en un principio clave de crecimiento:

#### “No se trata de conseguir más tráfico, sino de encontrar el canal adecuado y el mensaje adecuado para el cliente correcto.”

##### Tiene tres dimensiones: 

#### 1. Segmento: a quién se apunta.

#### 2. Propuesta de valor: qué problema se resuelve.

#### 3. Canal: cómo se llega al cliente.


### Sistema de adquisición: proceso de adquisición tiene 5 etapas

### 1. Atracción: generar atención y tráfico (awareness).

### 2. Conversión: transformar visitantes o leads en clientes.

### 3. Activación: lograr la primera experiencia de valor.

### 4. Optimización: medir, ajustar y escalar canales rentables.

### 5. Rentabilidad: controlar el costo de adquisición vs valor del cliente.


## 4. Relación con el ciclo de vida del cliente

##### La adquisición es solo la primera parte del ciclo de vida completo:

| Etapa                   | Objetivo                       |
| ----------------------- | ------------------------------ |
| Adquisición             | Atraer nuevos clientes         |
| Onboarding / Activación | Entregar valor inicial         |
| Retención               | Mantener el uso y satisfacción |
| Expansión               | Aumentar ingresos por cliente  |
| Referencia              | Generar promoción orgánica     |

##### Una empresa sana equilibra adquisición + retención, porque adquirir sin retener es como “llenar un balde con fugas”.


## 5. Economía de adquisición

El núcleo económico se mide con dos métricas fundamentales:

### 1. CAC (Customer Acquisition Cost): Costo total de marketing + ventas dividido por el número de clientes adquiridos. Refleja eficiencia.

### 2. LTV (Lifetime Value): Valor promedio que un cliente genera durante toda su relación con la empresa. Refleja retorno.

#### Para crecer de forma saludable, el ratio LTV:CAC debe ser mayor que 3:1.

##### Es decir, cada dólar invertido en adquirir un cliente debe generar al menos tres en valor futuro.


## Modelos y estrategias clave

### 1. Funnel de adquisición (Embudo)

#### Awareness → 2. Interest → 3. Consideration → 4. Intent → 5. Purchase. 

##### Cada etapa tiene métricas, contenido y canales específicos.


### 2. Flywheel (Rueda de crecimiento)

#### Modelo alternativo (usado por HubSpot) donde los clientes impulsan el crecimiento al generar referidos, reseñas y contenido.

##### El enfoque no es lineal, sino circular: adquisición alimenta retención, que alimenta nuevas adquisiciones.


### 3. Growth Loop

#### Basado en sistemas virales o de red donde cada cliente atrae automáticamente a más clientes (ej.: invitaciones, contenido compartible, marketplaces, etc.).

##### El objetivo es crear auto-propulsión en la adquisición.


## 7. Canales de adquisición: pueden clasificarse

### 1. Orgánicos: SEO, redes sociales, contenido, referidos. Escalables, bajo costo, lentos

### 2. Pagos: Ads, SEM, display, afiliados. Rápidos, medibles, costosos

### 3. Propios: Email, app, comunidad. Control total, requieren retención

### 4. Partnerships: Alianzas, integraciones, co-marketing. Alcance compartido, dependen de terceros

### 5. PR / Medios: Prensa, eventos, lanzamientos. Alta visibilidad, poco control 

#### El desafío es encontrar el canal donde el costo de adquisición es menor y la calidad del cliente mayor.
...
ROI / ROAS (Retorno sobre inversión / sobre publicidad)

Payback period: tiempo para recuperar el costo de adquisición

Channel attribution: entender qué canal generó la conversión


## 9. Métodos analíticos y de mejora

Cohort Analysis: mide adquisición y retención por grupos de usuarios.

A/B Testing: optimiza mensajes y conversiones.

Funnel Analysis: detecta cuellos de botella en el embudo.

Attribution Models: asigna crédito a canales.

Customer Segmentation: identifica audiencias con mayor rentabilidad.


## 10. Fundamentos estratégicos

### 1. Product–Market Fit: sin ajuste producto-mercado, la adquisición escala mal.

### 2. Canal–Model Fit: cada modelo de negocio requiere canales diferentes (ej.: SaaS vs e-commerce).

### 3. Mensaje–Mercado Fit: comunicar el valor correcto al público correcto.

### 4. Economía positiva: nunca escalar canales con CAC > LTV.

### 5. Iteración continua: adquisición se optimiza mediante experimentación (growth experiments).


## 11. Enfoques complementarios

#### Inbound marketing: atraer con contenido de valor.

#### Outbound marketing: buscar activamente prospectos.

#### Performance marketing: optimizar adquisición basada en datos.

#### Referral programs: convertir clientes en promotores.

#### Freemium / Trial: permitir experiencia sin fricción.


## Principio final

#### “Adquirir clientes no es cuestión de gastar más, sino de aprender más rápido qué canal, qué mensaje y qué producto generan crecimiento rentable.”

##### La adquisición eficaz combina: Ciencia (datos y experimentos). Arte (comunicación y empatía). Sistema (procesos repetibles y medibles)
...
# Personas / Arquetipo de clientes



# Atracción (Awareness / Discovery)

#### Es la fase donde todo comienza: cuando un cliente potencial descubre que existís, entiende qué hacés y empieza a interesarse.


## Definición

#### Es el conjunto de acciones y procesos que logran que personas que no conocen una marca o producto pasen a conocerla, entenderla y recordarla.

En otras palabras: es el momento en que “el cliente descubre que vos existís”.

##### No implica todavía una compra ni una decisión: solo atención, interés inicial y curiosidad.


## Fundamento

La atracción parte de un principio psicológico fundamental:

#### “Antes de que alguien pueda comprarte, debe saber que existís y debe reconocerse en tu mensaje.”

##### La atracción no busca vender directamente, sino construir visibilidad, relevancia y afinidad. 

#### Se trata de ser descubierto y comprendido en medio del ruido del mercado.

#### “Nadie compra lo que no conoce, pero tampoco lo que no entiende o no recuerda.”

la atracción combina:

### Alcance (que te vean),

### Claridad (que entiendan quién sos y qué ofrecés),

### Relevancia (que sientan que les puede importar).


## Objetivos esenciales de la etapa de atracción

### 1. Visibilidad: que te vean (notoriedad de marca).

### 2. Relevancia: que entiendan qué problema resolvés.

### 3. Resonancia: que sientan que tu mensaje es para ellos.

### 4. Recordación: que te tengan en mente cuando llegue el momento de decidir.


#### Crear conciencia: que el público objetivo sepa que existís.

#### Generar familiaridad y confianza inicial.

#### Transmitir tu propuesta de valor central.

#### Educar o inspirar curiosidad.

#### Iniciar el recorrido hacia la consideración y la conversión


## Niveles de conciencia del cliente (según Eugene Schwartz – Breakthrough Advertising)

Comprender en qué estado mental está el cliente es clave para diseñar estrategias efectivas:

### 1. Completamente inconsciente: no sabe que tiene un problema.

### 2. Consciente del problema: sabe que algo no anda bien.

### 3. Consciente de la solución: sabe que hay posibles formas de resolverlo.

### 4. Consciente del producto: conoce tu solución específica.

### 5. Completamente consciente: ya confía en tu marca o producto.

#### La atracción se enfoca en mover al cliente de los niveles 1–2 hacia 3–4: despertar conciencia del problema y asociarte con la posible solución.


## Componentes fundamentales de la atracción

### 1. Propuesta de valor clara: Qué ofrecés, para quién, y por qué es diferente. → Sin claridad, la atracción se dispersa.

### 2. Mensaje principal (Story / Narrative): Cómo comunicás esa propuesta en forma memorable y emocional.

### 3. Identidad visual y verbal: Logos, colores, tono, estilo, coherencia (branding).

### 4. Distribución: Dónde y cómo aparece tu mensaje. Los canales correctos son tan importantes como el mensaje

### 5. Consistencia: La repetición y coherencia generan familiaridad, y la familiaridad genera confianza.


## Canales y medios típicos de atracción

| Tipo                             | Ejemplos                               | Propósito                           |
| -------------------------------- | -------------------------------------- | ----------------------------------- |
| **Contenido orgánico (Inbound)** | Blogs, videos, redes, SEO, newsletters | Educar y atraer por valor           |
| **Publicidad paga (Paid Media)** | Google Ads, Meta Ads, YouTube, Display | Alcance rápido y segmentado         |
| **PR / Relaciones públicas**     | Medios, podcasts, conferencias, prensa | Credibilidad externa                |
| **Influencers / UGC**            | Recomendaciones y menciones sociales   | Confianza y autenticidad            |
| **Eventos / comunidades**        | Ferias, webinars, networking           | Contacto humano y afinidad          |
| **Referral awareness**           | Recomendaciones de clientes actuales   | Awareness orgánico con credibilidad |
...
| ---------------------------------- | --------------------------------- | ------------ |
| **Impresiones / Alcance**          | Cuántas personas te vieron        | Cuantitativo |
| **CTR (Click Through Rate)**       | Cuántos mostraron interés inicial | Cuantitativo |
| **Brand recall / aided awareness** | Cuántos recuerdan tu marca        | Cualitativo  |
| **Share of Voice**                 | Tu presencia vs competidores      | Estratégico  |
| **Engagement rate**                | Interacción con tu contenido      | Conductual   |
| **Search volume / mentions**       | Cuántos te buscan o mencionan     | Orgánico     |


## Estrategias psicológicas de atracción

### 1. Educación antes que promoción: ofrecer conocimiento o inspiración.

### 2. Storytelling: conectar emocionalmente antes de vender racionalmente.

### 3. Principio de reciprocidad: dar valor (contenido, herramientas, tips).

### 4. Efecto de familiaridad: exposición repetida mejora la confianza.

### 5. Autoridad y prueba social: mostrar validación externa.

### 6. Consistencia visual y narrativa: refuerza identidad y recordación.


## Conexión con las siguientes etapas: Consideración/Nurturing; Conversion; Retention

##### La atracción no tiene sentido aislada: debe diseñarse para conducir al siguiente paso.

| Etapa siguiente               | Qué se espera                        |
| ----------------------------- | ------------------------------------ |
| **Consideration / Nurturing** | El interesado busca más información  |
| **Conversion**                | Decide probar, registrarse o comprar |
| **Retention (posterior)**     | La promesa inicial debe cumplirse    |


#### Toda estrategia de awareness debe incluir un “puente” o call to action inicial, aunque suave: suscripción, descarga, registro, visita, etc.


## Fundamentos estratégicos de éxito: Una buena estrategia de atracción cumple con tres condiciones:

### 1. Relevancia: el mensaje resuena con el problema o deseo del público.

### 2. Claridad: la gente entiende de inmediato de qué se trata.

### 3. Consistencia: la marca mantiene presencia y coherencia en el tiempo.

##### Y a nivel sistémico, aprende constantemente: prueba distintos mensajes, analiza qué atrae mejor y ajusta.


## Principio final

#### “La atracción no busca convencer, busca conectar.”

#### El objetivo no es empujar ventas, sino sembrar una percepción positiva, crear curiosidad y confianza, y preparar el terreno para todo lo que viene después: conversión, retención y lealtad.



## Las 3 fases dentro de la atracción

#### Describen cómo evoluciona la relación del cliente potencial con la marca desde el primer contacto hasta el interés consciente.

#### Explican cómo se construye la conciencia de marca paso a paso, y cómo el cliente pasa de “ver algo” a “prestar atención” y finalmente “recordarlo o actuar”.

Fase  | Enfoque | Objetivo | Estado mental del cliente

### 1. Exposición (Exposure): Lograr ser visto. Que el cliente se cruce con tu marca. “Lo vi, pero no lo procesé.”

### 2. Atención / Reconocimiento (Attention / Recognition): Captar interés cognitivo y emocional. Que el cliente note y procese el mensaje. “Ah, esto me suena interesante.”

### 3. Recuerdo / Familiaridad (Recall / Familiarity): Consolidar presencia mental. Que el cliente recuerde tu marca y la asocie con una categoría o necesidad. “Conozco esa marca / sé qué hace.”


## 1. Exposición (Exposure): “Para que te recuerden, primero tienen que verte.”

#### Es el primer contacto visual o auditivo entre la marca y el cliente.

#### El objetivo es aparecer en su campo perceptual, aunque sea de manera pasiva.

##### La frecuencia y amplitud de exposición importan más que la profundidad inicial.

La exposición no garantiza atención, pero sin exposición no hay atención posible.

El efecto psicológico clave aquí es el “Mere Exposure Effect”:

##### Las personas tienden a preferir aquello que les resulta más familiar.

##### Ej: Un anuncio visto en redes aunque no se haga clic. Un logo repetido en varias publicaciones. Un producto mencionado en un podcast.
...
#### Frecuencia de exposición media.


## 2. Atención / Reconocimiento (Attention / Recognition)

“No basta con que te vean; deben detenerse un instante a mirarte.”

#### Aquí el cliente procesa el estímulo y distingue tu mensaje del ruido.

Es el momento en que la marca pasa del fondo al primer plano en su mente.


Fundamentos

#### La atención es selectiva y escasa: solo captás segundos del usuario.

#### El mensaje debe ser relevante, simple y emocionalmente resonante.

#### Se activan mecanismos de curiosidad, humor, sorpresa o identificación.


### Estrategias para captar atención

#### 1. Visuales potentes y memorables.

#### 2. Mensajes claros y concretos.

#### 3. Historias o metáforas breves.

#### 4. Apelar al “pain point” o deseo inmediato.

#### 5. Originalidad en tono o formato
...
Tasa de rebote (en visitas).


## Recuerdo / Familiaridad (Recall / Familiarity)

#### “La confianza empieza cuando el cliente siente que ya te conoce.”

Empieza a consolidarse una memoria de marca.


###  Fundamentos

#### La repetición (con variación) crea familiaridad.

#### La familiaridad genera confianza implícita.

#### La mente agrupa marcas por categorías mentales: “servicio de mensajería”, “app de finanzas”, “marca ecológica”.


#### Objetivo: Que cuando el cliente tenga una necesidad, tu marca aparezca entre las 2 o 3 opciones mentales accesibles (Top of Mind Awareness).


### Estrategias efectivas: 

#### 1. Consistencia visual y narrativa.

#### 2. Repetición distribuida (sin saturar).

#### 3. Presencia en múltiples contextos.

#### 4. Asociaciones emocionales positivas.

#### 5. Prueba social o testimonios.


### Métricas

#### Brand Recall (recordación espontánea).

#### Brand Recognition (reconocimiento asistido).

#### Share of Voice (presencia relativa en el mercado).

#### Search Volume (búsquedas de marca).


## Relación entre las 3 fases

Estas fases no son aisladas; forman un continuo progresivo dentro del proceso de atracción:

#### Exposición → Atención → Recuerdo → (Consideración → Conversión)

Cada fase construye la base de la siguiente:

Sin exposición, no hay atención.

Sin atención, no hay recuerdo.

Sin recuerdo, no hay consideración.

#### una estrategia de atracción efectiva no busca clics inmediatos, sino presencia sostenida y significativa que mueva al cliente a lo largo de este trayecto mental.


## Rs estrat

| Fase           | Meta principal            | Clave psicológica        | Error común            |
| -------------- | ------------------------- | ------------------------ | ---------------------- |
| **Exposición** | Ser visible               | Efecto de familiaridad   | No segmentar o saturar |
| **Atención**   | Generar interés           | Curiosidad / relevancia  | Mensajes genéricos     |
| **Recuerdo**   | Ser recordado y confiable | Confianza por repetición | Falta de consistencia  |



# Conversión (Conversion / Acquisition)

##### Una de las piezas centrales del viaje del cliente y del crecimiento empresarial.

#### Proceso mediante el cual un prospecto o público objetivo pasa a ser cliente real o activo.


## Definición

#### Momento/proceso en que una persona interesada realiza la acción deseada por la empresa:

##### comprar, registrarse, suscribirse, descargar, agendar una demo, etc.

##### la conversión es cuando el “potencial de valor” se transforma en valor real.

#### Su esencia es entender qué hace que alguien pase de “considerar” a “actuar”.


## Fundamento

##### “La conversión no ocurre porque el cliente entienda tu producto,

#### sino porque entiende por qué le conviene actuar ahora.”

#### La conversión es un fenómeno de decisión, no de información.

##### No basta con mostrar beneficios: hay que activar los gatillos psicológicos, emocionales y contextuales que llevan a la acción.


## Etapas internas del proceso de conversión: tres microfases

### 1. Intención: El prospecto muestra señales de interés o búsqueda activa. Captar y sostener motivación.

### 2. Evaluación / Decisión: Compara alternativas y calcula riesgos / beneficios. Reducir fricción, aumentar confianza.

### 3. Acción: Realiza la compra, suscripción o registro. Facilitar ejecución y confirmar valor.


## Componentes de la conversión

### 1. Valor percibido: El cliente no compra lo que es, sino lo que cree que obtendrá.

##### El valor percibido se construye sobre tres pilares:

#### 1. Relevancia: “Esto resuelve mi necesidad específica.”

#### 2. Diferenciación: “No es igual a los demás.”

#### 3. Confianza: “Creo que cumplirá su promesa.”

##### Sin valor percibido alto, no hay conversión, aunque el producto sea excelente.


### 2. Fricción

#### Toda barrera cognitiva, emocional o técnica que dificulta la acción:

##### Formularios largos.

##### Dudas sobre el precio o condiciones.
...
##### El trabajo del diseño de conversión (CRO — Conversion Rate Optimization) consiste en eliminar fricciones y reforzar motivaciones.


### 3. Urgencia y escasez

#### Plazos limitados (“solo hoy”) o cantidades limitadas (“últimos 5 cupos”) aumentan la motivación temporal.

Deben usarse éticamente: cuando reflejan condiciones reales.


### 4. Confianza y prueba social

##### Testimonios, reseñas, casos de éxito, certificaciones, garantías, devoluciones, etc.

#### Disminuyen el riesgo percibido, uno de los mayores inhibidores de acción.


### 5. Claridad: “Una mente confundida no compra.”

#### La claridad del mensaje, del precio y de los pasos de acción es esencial.

#####  Un CTA (Call to Action) debe ser visible, directo y específico.

Ejemplo:

##### No dar "Más información” sino “Empieza tu prueba gratuita de 7 días”


### 6. Timing: El contexto temporal y emocional del usuario:

#### ¿Está en modo exploración o decisión?

#### ¿Está emocionalmente listo?

#### ¿Le recordamos en el momento adecuado (remarketing, email, retargeting)?


## Fundamentos psicológicos

#### La conversión depende de cómo el cliente percibe el valor, el riesgo y la recompensa.

##### Principio | Aplicación

### 1. Heurística de disponibilidad: Mostrar ejemplos concretos aumenta credibilidad.

### 2. Prueba social: Mostrar cuántos ya compraron o se registraron.

### 3. Autoridad: Mostrar expertos, premios o experiencia.

### 4. Compromiso y consistencia: Microacciones (registrarse antes de comprar).

### 5. Reciprocidad: Dar valor antes de pedir acción (ebook, demo).

### 6. Pérdida percibida (Loss aversion): Mostrar lo que se pierde por no actuar.

### 7. Urgencia: Incentivar acción inmediata.


## Métricas

Conversion Rate (CR): CR = conversiones/visitas o leads * 100

Cost per Acquisition (CPA): cuánto cuesta cada cliente adquirido.

Lead-to-Customer Rate: proporción de leads que se vuelven clientes.

Cart Abandonment Rate (en e-commerce).

Activation Rate (en SaaS).


## Factores estratégicos

### 1. Segmentación: adaptar mensaje a etapa y perfil del prospecto.

### 2. Alineación entre marketing y ventas: evitar ruptura del flujo.

### 3. Automatización y nurturing: educar al lead con contenido relevante.

### 4. Pruebas A/B y experimentación: optimizar landing pages, precios, CTA.

### 5. Experiencia post-conversión: garantizar satisfacción inmediata para reforzar la decisión (inicio de la retención).


## Conversión como parte del viaje completo

#### es el punto de inflexión entre: la Atracción y Consideración, y la Retención y Fidelización.

##### Atracción → Consideración → Conversión → Retención → Lealtad

##### Optimizar la conversión no es aislar una tasa, sino entender y facilitar la decisión humana en el contexto del recorrido completo.


## Rs

| Pilar               | Pregunta guía                     | Meta                               |
| ------------------- | --------------------------------- | ---------------------------------- |
| **Valor percibido** | ¿Por qué debería actuar?          | Mostrar beneficios concretos.      |
| **Confianza**       | ¿Por qué debería creerte?         | Probar credibilidad y seguridad.   |
| **Claridad**        | ¿Qué tengo que hacer exactamente? | Simplificar el camino a la acción. |
| **Urgencia**        | ¿Por qué debería hacerlo ahora?   | Motivar el momento de acción.      |



# Prospecto

#### Persona u organización que cumple con ciertos criterios de cliente ideal y muestra algún nivel de interés o potencial de compra.

##### Es el punto intermedio entre un lead (contacto general) y un cliente (persona que ya compró).

##### Representa una oportunidad calificada, alguien que podría convertirse en cliente real si se le guía adecuadamente por el proceso de conversión.


## Fundamento

#### “Un prospecto no es cualquiera que te vea: es quien tiene una necesidad real, la capacidad de comprar y la disposición a considerar tu solución.”

La noción de prospecto se asienta sobre tres ejes:

### 1. Necesidad (fit o encaje del problema).

### 2. Capacidad (recursos o autoridad para decidir).

### 3. Interés (motivación o intención actual).

#### cuando esas tres dimensiones se alinean, hablamos de un prospecto genuino.
...
| ------------- | -------------------------------------------------------------------------------- | ------------------------- |
| **Lead**      | Contacto que ha mostrado un mínimo interés (visitó, se registró, descargó algo). | Curioso / en exploración. |
| **Prospecto** | Persona calificada que podría comprar pronto.                                    | Evaluando opciones.       |
| **Cliente**   | Persona que ya compró o contrató.                                                | En relación activa.       |

El prospecto es el punto de inflexión entre marketing y ventas, donde la comunicación pasa de masiva a personalizada


## Tipos de prospectos

### 1. Prospecto frío: No conoce la marca o no muestra interés actual. Requiere educación y credibilidad. Ejemplo: lista de contactos de una base de datos.

### 2. Prospecto templado: Muestra señales de interés, pero no urgencia. Ha interactuado con contenido, visitado la web, o pedido información. Requiere nutrición (lead nurturing) para madurar su decisión.

### 3. Prospecto caliente: Tiene intención activa de compra. Ha solicitado una demo, cotización o muestra. Requiere acción inmediata de ventas.


## Fundamentos de calificación (Qualification)

#### El proceso de convertir un lead en prospecto se llama lead qualification
  
#### Su propósito es determinar qué contactos tienen suficiente potencial real para justificar tiempo y recursos.


##### Modelos clásicos de calificación: Ayudan a detectar prospectos con potencial real, evitando perder tiempo en contactos no calificados.

### 1. BANT (Budget, Authority, Need, Timing): ¿Tiene presupuesto? ¿Tiene autoridad para decidir? ¿Tiene necesidad real? ¿Es el momento adecuado?

### 2. CHAMP (Challenges, Authority, Money, Prioritization): Se enfoca más en el problema que en el presupuesto.

### 3. GPCTBA/C&I (Goals, Plans, Challenges, Timeline, Budget, Authority, Consequences & Implications): Modelo más completo usado en ventas consultivas.


## Fundamentos psicológicos

#### Un prospecto está en un estado de exploración y evaluación, con sesgos cognitivos y emocionales específicos:

| Mecanismo                | Descripción                                       | Implicación práctica                   |
| ------------------------ | ------------------------------------------------- | -------------------------------------- |
| **Curiosidad**           | Busca entender si la oferta aplica a su caso.     | Mostrar relevancia inmediata.          |
| **Desconfianza inicial** | No confía aún en la marca.                        | Probar autoridad y experiencia.        |
| **Comparación social**   | Evalúa opciones según reputación y prueba social. | Mostrar testimonios, casos, cifras.    |
| **Aversión al riesgo**   | Prefiere no decidir que equivocarse.              | Ofrecer garantías, demos, bajo riesgo. |


### Perspectiva estratégica

Desde el punto de vista del viaje del cliente, el prospecto es el personaje principal de las fases de:

Atracción → Consideración → Conversión

### Durante ese trayecto, el objetivo de la empresa es:

#### Atraer al prospecto correcto.

#### Calificarlo según su encaje.

#### Educarlo sobre su problema y tu solución.

#### Acompañarlo hacia una decisión con mínima fricción.


## Procesos asociados a los prospectos

### 1. Generación de leads: atraer contactos relevantes.

### 2. Calificación: filtrar los que cumplen criterios de valor.

### 3. Nutrición: mantener comunicación útil y personalizada.

### 4. Conversión: guiar hacia la compra.

### 5. Feedback loop: analizar qué tipo de prospectos convierten mejor (para ajustar la adquisición).


## Métricas

| Métrica                             | Qué mide                                | Propósito                      |
| ----------------------------------- | --------------------------------------- | ------------------------------ |
| **Leads generados**                 | Volumen bruto de interés.               | Medir atracción.               |
| **Lead-to-Prospect Rate**           | % de leads calificados como prospectos. | Evaluar calidad.               |
| **Prospect-to-Customer Rate**       | % de prospectos que compran.            | Medir efectividad comercial.   |
| **Sales Cycle Length**              | Tiempo promedio de conversión.          | Optimizar eficiencia.          |
| **Customer Acquisition Cost (CAC)** | Costo promedio por cliente.             | Medir rentabilidad del embudo. |
...
| Concepto relacionado                             | Relación con el Prospecto                           |
| ------------------------------------------------ | --------------------------------------------------- |
| **Lead**                                         | Etapa previa (interés general).                     |
| **Cliente**                                      | Etapa posterior (acción completada).                |
| **Buyer Persona / ICP (Ideal Customer Profile)** | Define qué perfil puede ser un buen prospecto.      |
| **Embudo de ventas / funnel**                    | Representa su avance de lead → prospecto → cliente. |
| **CRM (Customer Relationship Management)**       | Sistema que gestiona y clasifica prospectos.        |
| **Nurturing**                                    | Comunicación que madura la intención de compra.     |


## Principio

##### “No se trata de tener más prospectos, sino de tener los correctos.”

El crecimiento sano proviene de:

Definir con precisión el perfil ideal.

Filtrar según calidad, no cantidad.

Acompañar con contenido y timing adecuados.

Integrar marketing y ventas para una experiencia fluida.


## Ejemplo 

#### Startup SaaS educativa: flujo de prospecto a cliente

1. Un usuario descarga un ebook sobre productividad → Lead.

2. El equipo nota que trabaja en educación y busca herramientas digitales → Prospecto calificado.

3. Le ofrecen una demo gratuita personalizada → Prospecto activo.

4. Tras la demo, compra el plan → Cliente.


# Lead

##### La base sobre la que se construye todo el sistema Lead → Prospecto → Cliente → Retención. 

#### Persona o entidad que ha mostrado algún interés inicial o interacción con tu marca, producto o servicio, dejando una señal de contacto o intención.

##### Es el primer nivel de relación reconocible entre una marca y un posible cliente.

##### Ej: Alguien que descarga un ebook. Se suscribe a un boletín. Rellena un formulario de contacto. Sigue la cuenta de la marca.


## Fundamento

#### “Un lead es una manifestación temprana de atención y curiosidad; aún no es un cliente, pero ya no es un desconocido.”

El lead representa potencial de relación.

#### El objetivo de la empresa es nutrir ese interés, entender si hay un encaje real (fit) y guiarlo hacia la conversión.

| Etapa         | Qué representa                             | Nivel de relación  |
| ------------- | ------------------------------------------ | ------------------ |
| **Lead**      | Contacto interesado, sin calificación aún. | Curiosidad.        |
| **Prospecto** | Lead calificado con potencial real.        | Consideración.     |
| **Cliente**   | Persona que compró o contrató.             | Acción / relación. |


## Tipos de Leads

### 1. Marketing Qualified Lead (MQL): Ha mostrado interés genuino en el contenido o propuesta de valor. Todavía no está listo para comprar. Ejemplo: descargó una guía o participó en un webinar.

### 2. Sales Qualified Lead (SQL): Ha demostrado intención más clara de compra. Listo para que el equipo de ventas actúe. Ejemplo: solicitó presupuesto o agendó una demo.

### 3. Product Qualified Lead (PQL) (común en SaaS): Ya ha probado el producto (por ejemplo, un free trial).  Ha mostrado señales de adopción activa.

### 4. Service Qualified Lead (ServQL): Cliente actual que muestra interés en adquirir otro servicio o plan. 
...
### 1. Atracción (Awareness): ¿Cómo hago que me descubran? SEO, redes, anuncios.

### 2. Interés / Valor: ¿Qué les doy a cambio de su atención?. Contenido, recursos, herramientas.

### 3. Captura / Permiso: ¿Cómo obtengo sus datos con consentimiento? Formularios, suscripciones, lead magnets.

#### La idea central es ofrecer valor antes de pedir acción (principio de reciprocidad de Cialdini).


## Elementos en un sistema de leads

### 1. Lead Magnet: contenido o incentivo gratuito que atrae al lead (ebook, checklist, demo, etc.).

### 2. Landing Page: página optimizada para captar leads.

### 3. Form / CTA: punto de conversión (el usuario deja su información).

### 4. CRM / Base de datos: donde se almacena y segmenta la información.

### 5. Lead Scoring: sistema para puntuar calidad o nivel de interés.

### 6. Nurturing (nutrición): flujo de mensajes o contenido para educar y acercar a la compra.


## Psicología del lead

#### Un lead suele estar en una fase de descubrimiento o aprendizaje, y su mente responde a estímulos de curiosidad y valor percibido.

### 1. Curiosidad: Quiere entender si la marca puede ayudarle. Generar intriga y claridad de beneficio.

### 2. Reciprocidad: Tiende a corresponder a lo recibido. Dar valor gratuito real.

### 3. Bajo riesgo: Acepta microcompromisos antes que grandes decisiones. Formularios cortos, contenido útil.

### 4. Familiaridad: Reacciona mejor a mensajes repetidos o consistentes. Consistencia de branding y tono.


## Métricas

#### Leads generados: Volumen total en un período. Medir atracción.

#### Lead Cost (CPL): Costo promedio por lead. Medir eficiencia de adquisición.

#### Lead-to-MQL Rate: % de leads que cumplen criterios de marketing. Evaluar calidad inicial.

#### MQL-to-SQL Rate: % de leads que llegan a ventas. Medir efectividad de calificación.

#### Lead Conversion Rate: % de leads que se convierten en clientes. Medir eficiencia global.


## Fundamento estratégico: “No se trata de generar más leads, sino de generar los correctos.”

#### “No se trata de generar más leads, sino de generar los correctos.”

#### Definir quién tiene valor real para la empresa.

#### Evitar atraer curiosos irrelevantes.

#### Alinear marketing y ventas en un lenguaje común.


## Del lead al cliente: flujo general

#### Atracción → Lead → Calificación → Prospecto → Conversión → Cliente → Retención

##### Cada fase requiere distintas estrategias, métricas y herramientas, pero todas deben estar alineadas en un mismo recorrido de valor.

#### El manejo inteligente de leads consiste en: 1) Sembrar en los lugares correctos (segmentación). 2) Regar con contenido y seguimiento (nurturing). 3) Cultivar relaciones a largo plazo (retención y referidos).
...
##### Forman un ecosistema interconectado, se puede representar como un ciclo de vida del cliente (Customer Lifecycle).


## Ciclo General del Cliente: puede dividirse en 7 grandes macroetapas:

### 1. Atracción (Awareness / Discovery)

### 2. Conversión (Conversion / Acquisition)

### 3. Activación (Activation / Onboarding)

### 4. Valor y Retención (Engagement / Retention)

### 5. Expansión (Upsell / Cross-sell / Advocacy)

### 6. Deserción (Churn)

### 7. Recuperación (Winback)


## Etapas y conceptos principales 

### 1. Atracción (Awareness & Lead Generation). Objetivo: que los desconocidos te conozcan.

Conceptos clave: 

#### Lead generation: generación de contactos o prospectos.

#### Traffic acquisition: atracción de tráfico.

#### Inbound marketing: atraer con contenido útil.

#### Outbound marketing: búsqueda activa (cold emails, ads, llamadas).

#### Brand awareness: notoriedad y recordación de marca.

#### Demand generation: crear necesidad antes de que exista intención.

#### Top of funnel (TOFU): primeras etapas del embudo.

#### Targeting / Segmentation: definir a quién se quiere atraer.


### 2. Conversión (Conversion / Acquisition)

#### Objetivo: transformar prospectos en clientes.

Conceptos clave:

#### Conversion rate optimization (CRO): mejora de tasas de conversión.

#### Landing pages / CTAs / Funnels: estructuras para convertir.

#### Unit economics / CAC / LTV: economía de adquisición.

#### Lead nurturing: madurar prospectos con contenido o comunicación.

#### Sales enablement: herramientas que ayudan a ventas.

#### Marketing automation: flujos automatizados para convertir.


### 3. Activación (Activation / Onboarding)

#### Objetivo: lograr que el cliente obtenga valor temprano y tangible.

Conceptos clave:

#### Onboarding: proceso de incorporación inicial.

#### Aha Moment: instante en que el cliente entiende el valor.

#### Time to Value (TTV): tiempo que tarda en percibir ese valor.

#### First experience: primera interacción significativa.

#### User education / product tours: guías de aprendizaje.

#### Adoption: adopción real del producto.


### 4. Valor y Retención (Engagement / Retention)

#### Objetivo: mantener la relación viva y valiosa.

Conceptos:

#### Customer success: ayudar activamente al cliente a lograr sus objetivos.

#### Engagement: frecuencia, intensidad y satisfacción de uso.

#### Customer experience (CX): percepción integral de la marca.

#### Churn prevention: prevención de abandono.

#### Loyalty programs: programas de lealtad o recompensas.
...
### 5. Expansión (Growth & Advocacy)

#### Objetivo: hacer crecer el valor por cliente y convertirlo en promotor.

Conceptos:

#### Upsell: vender versiones superiores o complementos.

#### Cross-sell: venta cruzada de productos relacionados.

#### Referral programs: programas de referidos.

#### Word of mouth / virality: crecimiento orgánico por recomendación.

#### Customer advocacy: clientes que defienden la marca públicamente.

#### Community building: creación de comunidad de usuarios.


### 6. Deserción (Churn / Attrition)

#### Objetivo: comprender por qué se van y reducirlo.

#### Churn rate: porcentaje de pérdida de clientes.

#### Exit surveys / feedback loops: entender razones de abandono.

#### Cohort analysis: analizar retención y abandono por grupos.

#### Customer health score: indicador de riesgo de pérdida.


## 7. Recuperación (Winback / Re-engagement)

#### Objetivo: recuperar clientes o leads dormidos.

#### Winback campaigns: campañas de reactivación.

#### Re-engagement emails: mensajes personalizados para volver.

#### Dormant user analysis: análisis de usuarios inactivos.

#### Personalized incentives: ofertas específicas para recuperar.

#### Feedback & re-onboarding: entender por qué se fueron y relanzar valor.


## Conceptos transversales (a todas las etapas)

### 1. Segmentation / Personas: Entender quién es el cliente.

### 2. Customer Journey Mapping: Visualizar toda su experiencia.

### 3. Voice of Customer (VoC): Escuchar activamente feedback.

### 4. CRM (Customer Relationship Management): Gestionar relaciones en datos.

### 5. Lifecycle Marketing: Adaptar mensajes según etapa del ciclo.

### 6. Attribution Models: Medir qué canal o acción generó qué resultado.

### 7. Growth Loops: Diseñar sistemas de adquisición y retención autoalimentados.

### 8. Behavioral Data / Analytics: Medir comportamiento y patrones de uso.


## Marco mental: Ej. Ecosistema de clientes

```
Awareness → Consideration → Conversion → Activation → Retention → Expansion → Winback
        ↑—————————————————— Feedback, Insights & Analytics ——————————————————↑

```

#### Cada flecha representa aprendizaje.

#### El growth real ocurre cuando los datos y aprendizajes de cada etapa se reinvierten en mejorar las anteriores.


## Conceptos complementarios avanzados

#### Customer Lifecycle Management (CLM): gestión integral del ciclo de vida.

#### Customer Journey Analytics (CJA): análisis detallado de recorridos.

#### Customer Centricity: estrategia centrada en el cliente, no en el producto.

#### Service Design: diseño holístico de la experiencia de servicio.

#### Product-Led Growth (PLG): adquisición y retención impulsadas por el producto.

#### Growth Marketing / Growth Experiments: mejora continua basada en datos.

#### CSAT / CES: métricas de satisfacción y esfuerzo del cliente.


## Visión sistémica

### 1. Adquisición: Traer clientes nuevos. CAC, CTR, CVR

### 2. Retención: Mantenerlos activos. Churn, LTV, NPS

### 3. Expansión: Aumentar su valor. ARPU, MRR growth, referrals

#### Y todo esto se coordina con: “Customer Experience + Product + Data” → Crecimiento sostenible.
